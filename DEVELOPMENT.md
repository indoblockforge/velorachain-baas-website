...
```bash
git remote add encore encore://velorachain-baas-website-f2ki
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/velorachain-baas-website-f2ki/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/velorachain-baas-website-f2ki/settings/integrations/github)
