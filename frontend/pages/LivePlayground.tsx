...
export default function LivePlayground() {
  ...
  return (
    <div className="max-w-4xl mx-auto py-10">
      <Card>
        <CardHeader>
          <h2 className="text-2xl font-bold mb-2">Live Playground API/SDK</h2>
          <p className="text-gray-600">Coba endpoint utama: Auth, Contract, Wallet. Session & token aman.</p>
