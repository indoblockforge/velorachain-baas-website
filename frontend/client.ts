 ...
 */
import { submitContact as api_contact_submit_submitContact } from "~backend/contact/submit";
import { subscribe as api_contact_subscribe_subscribe } from "~backend/contact/subscribe";
...
export namespace contact {
    ...
    export class ServiceClient {
        ...
        public async submitContact(params: RequestType<typeof api_contact_submit_submitContact>): Promise<ResponseType<typeof api_contact_submit_submitContact>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/contact`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_contact_submit_submitContact>
        }

        public async subscribe(params: RequestType<typeof api_contact_subscribe_subscribe>): Promise<ResponseType<typeof api_contact_subscribe_subscribe>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/newsletter/subscribe`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_contact_subscribe_subscribe>
        }
    }
}
